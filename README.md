...
Only the main paper background changes from Kami's `#fff8ed` to white. Typography, hierarchy, editorial marks and the macOS code window retain the local Kami definitions. SiYuan's official daylight shell is not restyled.
